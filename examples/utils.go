...
import (
	...
	sdkutils "github.com/wd-idonan/sdk-go/v2/utils"
)
...
var users = map[string]*User{
	...
	"org1admin1": {
		"./chaindata/hotfix/crypto-config/bcn1.bitschain.com/user/admin1/admin1.tls.key",
		"./chaindata/hotfix/crypto-config/bcn1.bitschain.com/user/admin1/admin1.tls.crt",
		"./chaindata/hotfix/crypto-config/bcn1.bitschain.com/user/admin1/admin1.sign.key",
		"./chaindata/hotfix/crypto-config/bcn1.bitschain.com/user/admin1/admin1.sign.crt",
	},
	"org2admin1": {
		"./chaindata/hotfix/crypto-config/bcn2.bitschain.com/user/admin1/admin1.tls.key",
		"./chaindata/hotfix/crypto-config/bcn2.bitschain.com/user/admin1/admin1.tls.crt",
		"./chaindata/hotfix/crypto-config/bcn2.bitschain.com/user/admin1/admin1.sign.key",
		"./chaindata/hotfix/crypto-config/bcn2.bitschain.com/user/admin1/admin1.sign.crt",
	},
	"org3admin1": {
		"./chaindata/hotfix/crypto-config/bcn3.bitschain.com/user/admin1/admin1.tls.key",
		"./chaindata/hotfix/crypto-config/bcn3.bitschain.com/user/admin1/admin1.tls.crt",
		"./chaindata/hotfix/crypto-config/bcn3.bitschain.com/user/admin1/admin1.sign.key",
		"./chaindata/hotfix/crypto-config/bcn3.bitschain.com/user/admin1/admin1.sign.crt",
	},
	"org4admin1": {
		"./chaindata/hotfix/crypto-config/bcn4.bitschain.com/user/admin1/admin1.tls.key",
		"./chaindata/hotfix/crypto-config/bcn4.bitschain.com/user/admin1/admin1.tls.crt",
		"./chaindata/hotfix/crypto-config/bcn4.bitschain.com/user/admin1/admin1.sign.key",
		"./chaindata/hotfix/crypto-config/bcn4.bitschain.com/user/admin1/admin1.sign.crt",
	},
	"org5admin1": {
